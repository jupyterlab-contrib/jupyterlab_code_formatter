...
def setup_handlers(web_app: NotebookWebApplication) -> None:
    ...
    web_app.add_handlers(
        host_pattern,
        [
            (url_path_join(web_app.settings["base_url"], "/jupyterlab_code_formatter/formatters"),
    ...
    web_app.add_handlers(
        host_pattern,
        [
            (url_path_join(web_app.settings["base_url"], "/jupyterlab_code_formatter/format"),
             FormatAPIHandler),
        ],
    )
...
class FormatAPIHandler(APIHandler):
    ...
    def post(self) -> None:
        ...
        if formatter_instance is None or not formatter_instance.importable:
            ...
            formatted_code = formatter_instance.format_code(data['code'], **(data['options'] or {}))
