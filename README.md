...
This basically says "Under edit mode (detected through the selector), using the chord Ctrl K + Ctrl L, invoke the `jupyterlab_code_formatter:black` command". And there you have it :tada:
